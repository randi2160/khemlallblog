    ...
    <?php } ?>
        ...
        ?>
			...
			<div class="powered-text">
				<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'blog-new' ) ); ?>"><?php
					/* translators: %s: CMS name, i.e. WordPress. */
					printf( esc_html__( 'Proudly powered by %s', 'blog-new' ), 'WordPress' );
				?></a>
				<span class="sep"> | </span>
				<?php
					/* translators: 1: Theme name, 2: Theme author. */
					printf( esc_html__( 'Theme: %1$s by %2$s.', 'blog-new' ), 'Blog New', '<a href="http://www.candidthemes.com/">Candid Themes</a>' );
				?>
			</div>
			<?php 
